...
final class Version20240207194227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user (username, email, roles, password ) VALUES (?, ?, ?, ?)', [
            'Anonymous',
        ...
        $this->addSql('UPDATE task SET user_id = ?', [$id]);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("DELETE FROM user WHERE email = 'anonymous@example.com'");
    }
